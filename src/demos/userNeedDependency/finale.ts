 ...
 * gate), then swaps the mascot's dialog panel to `Mascot.showRecap` — a three-line recap of the
 * whole session (value chain, map, strategic thinking) plus an external CTA link to
