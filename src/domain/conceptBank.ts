...
export const CONCEPT_BANK: Concept[] = [
  ...
  },
  {
    ...
    definition: "In Wardley Mapping, we use the right methods (Agile, Lean, or Six Sigma) based on evolutionary stage.",
    applicableKinds: ["capability"],
  ...
  },
  {
    ...
    definition: "In Wardley Mapping, things that are highly evolved tend to make good building blocks.",
    applicableKinds: ["capability"],
  ...
  },
  {
    ...
    category: "leadership",
    label: "Alliances",
    definition: "In Wardley Mapping, we know we don't have to do everything alone — we could work together through an alliance.",
    applicableKinds: ["capability"],
