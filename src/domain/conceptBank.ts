...
export const CONCEPT_BANK: Concept[] = [
  ...
  },
  {
    ...
    category: "climate",
    label: "Inertia",
    definition: "In Wardley Mapping, we watch out for Inertia — anything that holds us back from adapting to change.",
  ...
  },
  {
    ...
    definition: "In Wardley Mapping, some things are truly Differentiation, while others are just Tablestakes.",
    applicableKinds: ["capability", "need"],
  ...
  },
  {
    ...
    definition: "In Wardley Mapping, things that are highly evolved tend to make good building blocks. In other words, Efficiency Enables Innovation.",
    applicableKinds: ["capability"],
  ...
  },
  {
    ...
    category: "leadership",
    label: "Build / Buy / Outsource",
    definition: "In Wardley Mapping, we use the stage of evolution to guide whether to Build / Buy / Outsource.",
    applicableKinds: ["capability"],
  ...
  },
  {
    ...
    category: "leadership",
    label: "Alliances",
    definition: "In Wardley Mapping, we know we don't have to do everything alone — we could work together through Alliances.",
    applicableKinds: ["capability"],
  ...
  },
  {
    ...
    category: "leadership",
    label: "Education",
    definition: "In Wardley Mapping, we consider an Education play if making people smarter can make a big difference. ",
    applicableKinds: ["capability", "need"],
    applicableStages: ["Genesis", "Custom-Built", "Product"],
